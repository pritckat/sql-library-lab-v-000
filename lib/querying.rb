...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(*) as book_count FROM characters JOIN character_books ON character.id = character_books.character_id GROUP BY characters.name ORDER BY book_count DESC"
end
